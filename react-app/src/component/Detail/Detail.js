...
const Detail = (props) => {
    ...
    return (
        <div className={'Detail'}>
            <DetailHeader nowstuData={props.nowstuData} setnowstuData={props.setnowstuData} delStudent={props.delStudent} modifyStudent={props.modifyStudent} changedData={props.changedData}></DetailHeader>
